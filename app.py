...
with imcol3:
    st.write("")
st.markdown("<p style='text-align: center; color: black; font-size:23px;'><span style='font-weight: bold'></span>Working with a Large Language Model Vertex AI </p>", unsafe_allow_html=True)
...
st.markdown("<p style='text-align: center; color: blue;margin-top: -10px ;font-size:20px;'><span style='font-weight: bold'></span>Vertex AI Powered Business Application</p>", unsafe_allow_html=True)
